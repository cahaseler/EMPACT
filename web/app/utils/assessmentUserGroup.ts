...
export async function findMany(args: PrismaClient.Prisma.AssessmentUserGroupFindManyArgs) {
    return await db.assessmentUserGroup.findMany(args)
}

export async function findUnique(args: PrismaClient.Prisma.AssessmentUserGroupFindUniqueArgs) {
    return await db.assessmentUserGroup.findUnique(args)
}

export async function create(args: PrismaClient.Prisma.AssessmentUserGroupCreateArgs) {
    return await db.assessmentUserGroup.create(args)
}

export async function update(args: PrismaClient.Prisma.AssessmentUserGroupUpdateArgs) {
    return await db.assessmentUserGroup.update(args)
}

export async function upsert(args: PrismaClient.Prisma.AssessmentUserGroupUpsertArgs) {
    return await db.assessmentUserGroup.upsert(args)
}

export async function delete_(args: PrismaClient.Prisma.AssessmentUserGroupDeleteArgs) {
