...
export async function findMany(args: PrismaClient.Prisma.AssessmentCollectionUserFindManyArgs) {
    return await db.assessmentCollectionUser.findMany(args)
}

export async function findUnique(args: PrismaClient.Prisma.AssessmentCollectionUserFindUniqueArgs) {
    return await db.assessmentCollectionUser.findUnique(args)
}

export async function create(args: PrismaClient.Prisma.AssessmentCollectionUserCreateArgs) {
    return await db.assessmentCollectionUser.create(args)
}

export async function update(args: PrismaClient.Prisma.AssessmentCollectionUserUpdateArgs) {
    return await db.assessmentCollectionUser.update(args)
}

export async function upsert(args: PrismaClient.Prisma.AssessmentCollectionUserUpsertArgs) {
    return await db.assessmentCollectionUser.upsert(args)
}

export async function delete_(args: PrismaClient.Prisma.AssessmentCollectionUserDeleteArgs) {
