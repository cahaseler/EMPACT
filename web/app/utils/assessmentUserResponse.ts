...
export async function findMany(
  args: PrismaClient.Prisma.AssessmentUserResponseFindManyArgs
) {
  return await db.assessmentUserResponse.findMany(args)
}

export async function findUnique(
  args: PrismaClient.Prisma.AssessmentUserResponseFindUniqueArgs
) {
  return await db.assessmentUserResponse.findUnique(args)
}

export async function create(
  args: PrismaClient.Prisma.AssessmentUserResponseCreateArgs
) {
  return await db.assessmentUserResponse.create(args)
}

export async function update(
  args: PrismaClient.Prisma.AssessmentUserResponseUpdateArgs
) {
  return await db.assessmentUserResponse.update(args)
}

export async function upsert(
  args: PrismaClient.Prisma.AssessmentUserResponseUpsertArgs
) {
  return await db.assessmentUserResponse.upsert(args)
}

export async function delete_(
  args: PrismaClient.Prisma.AssessmentUserResponseDeleteArgs
) {
