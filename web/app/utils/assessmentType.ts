...
export async function findMany(args: PrismaClient.Prisma.AssessmentTypeFindManyArgs) {
    return await db.assessmentType.findMany(args)
}

export async function findUnique(args: PrismaClient.Prisma.AssessmentTypeFindUniqueArgs) {
    return await db.assessmentType.findUnique(args)
}

export async function create(args: PrismaClient.Prisma.AssessmentTypeCreateArgs) {
    return await db.assessmentType.create(args)
}

export async function update(args: PrismaClient.Prisma.AssessmentTypeUpdateArgs) {
    return await db.assessmentType.update(args)
}

export async function upsert(args: PrismaClient.Prisma.AssessmentTypeUpsertArgs) {
    return await db.assessmentType.upsert(args)
}

export async function delete_(args: PrismaClient.Prisma.AssessmentTypeDeleteArgs) {
