...
export async function findMany(args: PrismaClient.Prisma.AssessmentCollectionFindManyArgs) {
    return await db.assessmentCollection.findMany(args)
}

export async function findUnique(args: PrismaClient.Prisma.AssessmentCollectionFindUniqueArgs) {
    return await db.assessmentCollection.findUnique(args)
}

export async function create(args: PrismaClient.Prisma.AssessmentCollectionCreateArgs) {
    return await db.assessmentCollection.create(args)
}

export async function update(args: PrismaClient.Prisma.AssessmentCollectionUpdateArgs) {
    return await db.assessmentCollection.update(args)
}

export async function upsert(args: PrismaClient.Prisma.AssessmentCollectionUpsertArgs) {
    return await db.assessmentCollection.upsert(args)
}

export async function delete_(args: PrismaClient.Prisma.AssessmentCollectionDeleteArgs) {
