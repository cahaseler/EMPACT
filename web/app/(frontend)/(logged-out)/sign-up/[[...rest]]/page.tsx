            ...
            <CardHeader className="p-4">
              ...
              <div className="text-sm text-description">
                <p>
                  ...
                  using the EMPACT application. Any unauthorized access or
            ...
            <CardHeader className="p-4">
              ...
              <div className="text-sm text-description">
                <p>
                  ...
                  intended purpose and only access information for which you
                  have been granted access. You also agree not to attempt to
                  access information to which access has not been granted, and
                  not to use this application for any malicious or illegal
                  activities. You understand that use of this application is
                  monitored and logged, and that unauthorized access or use of
                  this application is subject to criminal or civil penalties.
