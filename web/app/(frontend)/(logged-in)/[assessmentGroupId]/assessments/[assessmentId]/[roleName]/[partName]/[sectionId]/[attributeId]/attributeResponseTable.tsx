"use client"
import { User, AssessmentUserResponse, Level } from "@/prisma/mssql/generated/client"
import {
    Table,
    TableBody,
    TableCell,
            ...
            <Table className="dark:bg-transparent">
                ...
                <TableBody>
                    {userResponses.length > 0 ? 
                        userResponses.map((userResponse: AssessmentUserResponse & { user?: User }) => {
                        ...
                        return (
                            <TableRow key={userResponse.id}>
                                ...
                                <TableCell>{userResponse.user?.lastName}, {userResponse.user?.firstName}</TableCell>
