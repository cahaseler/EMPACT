...
console.log(
  "Running this sync script will replace the contents of web_static/app with the contents of web/app - you should not be making changes in web_static/app anyway."
);
